        ...
        <div className="flex justify-center items-center flex-col">
          ...
          <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center xl:gap-y-16 gap-y-20 gap-x-16 lg:gap-x-20 xl:gap-x-0 lg:px-10 xl:px-0">
            ...
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              ...
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center">
                <p>NewCo is a Data & Technology driven organisation with an engineering mindset, focused on solving the most business-critical problems for our clients.</p>
              </div>
            </div>
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              <div className="mb-6">
              ...
              <div className="text-gray-600 dark:text-gray-300 mt-2 text-lg text-center">
                <p>NewCo is a team of Organisational Development practitioners focused on solving the people dynamics, culture and leadership challenges for our clients. </p>
              </div>
            </div>
            <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
              <div className="mb-6">
