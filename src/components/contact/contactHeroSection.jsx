...
const contactHeroSection = () => {
    ...
    return (
        <div className="container mx-auto pt-16" style={{paddingLeft: "50px", paddingRight: "50px", paddingTop: "50px", paddingBottom: "50px"}}>
                ...
                <div className="xl:w-2/5 lg:w-2/5 bg-indigo-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                    <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                        ...
                        <div className="flex pb-4 items-center">
                            ...
                            <p className="pl-4 text-white text-base">+0 1 234 567</p>
                        </div>
